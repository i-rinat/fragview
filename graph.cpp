...
int main(int argc, char *argv[]) {
	...
	// const char *initial_dir = "/home/rinat/Видео";
	// const char *initial_dir = "/home/rinat";
	// const char *initial_dir = "/var/lib/dpkg/info";
	// const char *initial_dir = "/media/TOSHEXT4/temp/1";
...
//	collect_fragments(initial_dir, &files2);
	...
	GList *list = NULL;
	list = g_list_append(list, g_strdup("hello"));
	list = g_list_append(list, g_strdup("world"));
